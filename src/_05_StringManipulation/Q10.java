...
public class Q10 {
	 ...
	 */
    	...
    	System.out.println("Adinizi soyadinizi ve 16 haneli KK numaranizi giriniz");
    			
    	String bilgiler=scan.nextLine();
   
    	String KK=bilgiler.replaceAll("\\D", "");
    	
    	if (KK.length()<16 || KK.length()>16){
			System.out.println("Geçersiz kredi kartı numarası");
		} else {
			System.out.println(bilgiler.substring(1,bilgiler.indexOf(' ')));
		}	
